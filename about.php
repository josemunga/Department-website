      ...
      <div class="group btmspace-30"> 
		...
		<div class="group"> 
          ...
          <ul class="nospace">
            ...
            <li class="btmspace-15"><a href="#"><em class="heading">Some Fancy heading</em> <img class="borderedbox" src="images/images/desktop-vs-laptop.png" alt=""></a>
			some fancy explanation here
			</li>
            <li class="btmspace-15"><a href="#"><em class="heading">Some other Fancy Heading</em> <img class="borderedbox" src="images/images/simulatin a simulator.png" alt=""></a>
			some other fancy explanation here
			</li>
			<li class="btmspace-15"><a href="#"><em class="heading">Yet Another Fancy heading!</em> <img class="borderedbox" src="images/images/visual studio.png" alt=""></a>
			yet another fancy explanation here!
			</li>
          </ul>
          <!-- ################################################################################################ --> 
        </div>
...
<!-- ################################################################################################ --> 
        ...
        <div class="one_half"> 
          <!-- ################################################################################################ -->
          <h2><p style="text-align: center;"><span style="font-size: large; font-family: times new roman,times;"><strong>FACULTY OF ENGINEERING, SCIENCE AND TECHNOLOGY</strong></span></p></h2>

<?php
include('chunks/aboutchunk.php');
?>
          <!-- ################################################################################################ --> 
        </div>
        <!-- / Middle Column --> 		
