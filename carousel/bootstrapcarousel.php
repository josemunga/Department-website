    ...
    <div class="container">
        ...
        <div id="slider1_container" style="visibility: hidden; position: relative; margin: 0 auto; width: 1140px; height: 442px; overflow: hidden;">
            ...
            <div u="loading" style="position: absolute; top: 0px; left: 0px;">
                ...
                <div style="position: absolute; display: block; background: url(carousel/img/loading.gif) no-repeat center center;
            ...
            <style>
                ...
                */
                ...
                .jssorb05 div, .jssorb05 div:hover, .jssorb05 .av {
                    ...
                    width: 16px;
                    height: 16px;
                    background: url(carousel/img/b05.png) no-repeat;
                    overflow: hidden;
                    cursor: pointer;
                }
            ...
            <style>
                ...
                */
                .jssora11l, .jssora11r {
                    ...
                    height: 37px;
                    cursor: pointer;
                    background: url(carousel/img/a11.png) no-repeat;
                    overflow: hidden;
                }
...
<!-- ze new slidder in town!! --> 
    ...
    <script src="carousel/ie10-viewport-bug-workaround.js"></script>

    <!-- jssor slider scripts-->
    <!-- use jssor.slider.debug.js for debug -->
    <script type="text/javascript" src="carousel/js/jssor.slider.mini.js"></script>
    <script>
